            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Add Questionnaire</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('admin.questionnaire.store')}}" method="POST"  id="create-form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group mt-3">
                                                    ...
                                                    <select name="is_active" class="form-select">
                                                        ...
                                                        <option value="0" {{old('is_active') == '0' && old('is_active') != '' ? 'selected' : ''}}>No</option>
                                                    </select>
                                                </div>
                                                @error('is_active')
                                                    <p class="text-danger">{{$message}}</p>
